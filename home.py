...
def func3():     
    ...
    screen3.title('CONTRA REGISTER')
    screen3.geometry('1500x770')
    sbmibtn13 = Button(screen3, text='Cash',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=1200, y=50)
    sbmibtn14 = Button(screen3, text='Abc Pvt Ltd',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=1200, y=70)
    sbmibtn15 = Button(screen3, text='For 1-April-22',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=1200, y=90)
    sbmibtn16 = Button(screen3, text='Transactions',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=1030, y=110)
    sbmibtn16 = Button(screen3, text='Credit',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=1100, y=130)
    sbmibtn16 = Button(screen3, text='Debit',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=950, y=130)
   
    sbmibtn = Button(screen3, text='APRIL',command=create57,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=170)
    sbmibtn2 = Button(screen3, text='MAY',command=create58,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=200)
    sbmibtn3 = Button(screen3, text='JUNE',command=create59,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=230)
    sbmibtn4 = Button(screen3, text='JULY', command=create60, fg='black',font=('Arial',9),activebackground='palegreen', width=30, border=0).place(y=260)
    sbmibtn5 = Button(screen3, text='AUGUST',command=create61,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=290)
    sbmibtn6 = Button(screen3, text='SEPTEMBER',command=create62,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=320)
    sbmibtn7 = Button(screen3, text='OCTOBER',command=create63,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=350)
    sbmibtn8 = Button(screen3, text='NOVEMBER', command=create64, fg='black',font=('Arial',9),activebackground='palegreen', width=30, border=0).place(y=380)
    sbmibtn9 = Button(screen3, text='DECEMBER',command=create65,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=410)
    sbmibtn10 = Button(screen3, text='JANUARY',command=create66,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=440)
    sbmibtn11 = Button(screen3, text='FEBRUARY',command=create67,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=470)
    sbmibtn12 = Button(screen3, text='MARCH', command=create68, fg='black',font=('Arial',9),activebackground='palegreen', width=30, border=0).place(y=500)
    ...
    Label(screen3, text='CONTRA REGISTER',bg="lightblue",font='17',fg="black",width=430).pack() 
...
def func13():
    ...
    sbmibtn = Button(screen13, text='Primary',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=100)
    sbmibtn = Button(screen13, text='Bank Accounts',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=120)
    sbmibtn = Button(screen13, text='Bank OCC A/c',command=create11,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=140)
    sbmibtn = Button(screen13, text='Bank OD A/c',command=create12,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=160)
    sbmibtn = Button(screen13, text='Branch /Divisions',command=create13,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=180)
    sbmibtn = Button(screen13, text='Capital Account',command=create14,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=200)
    sbmibtn = Button(screen13, text='Cash in Hand ',command=create15,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=220)
    sbmibtn = Button(screen13, text='Current Assets',command=create16,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=240)
    sbmibtn = Button(screen13, text='Current Liabilities',command=create17,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=260)
    sbmibtn = Button(screen13, text='Deposits (Assets)',command=create18,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=280)
    sbmibtn = Button(screen13, text='Direct Expenses',command=create19,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=300)
    sbmibtn = Button(screen13, text='Direct Incomes',command=create20,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=320)
    sbmibtn = Button(screen13, text='Duties and Taxes',command=create21,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=340)
    sbmibtn = Button(screen13, text='Expenses(Direct)',command=create22,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=360)
    sbmibtn = Button(screen13, text='Expenses(Indirect)',command=create23,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=380)
    sbmibtn = Button(screen13, text='Fixed Assets',command=create24,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=400)
    sbmibtn = Button(screen13, text='Income(Direct)',command=create25,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=420)
    sbmibtn = Button(screen13, text='Income (Indirect)',command=create26,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=440)
    sbmibtn = Button(screen13, text='Indirect Expenses',command=create27,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=460)
    sbmibtn = Button(screen13, text='Indirect Incomes',command=create28,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=480)
    sbmibtn = Button(screen13, text='Investments',command=create29,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=500)
    sbmibtn = Button(screen13, text='Loans and Advances(Assets)',command=create30,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=520)
    sbmibtn = Button(screen13, text='Loans (Liability)',command=create31,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=540)
    sbmibtn = Button(screen13, text='Misc. Expenses(ASSET)',command=create32,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=560  )
    Label(screen13, text='GROUP SUMMARY',bg="lightblue",font='17',fg="black",width=430).pack()    
def func14():
    global screen14
